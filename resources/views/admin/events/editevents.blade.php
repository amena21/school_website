      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="{{url('/updateevents',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf 
                ...
                <img style="height:150px;width:150px;" src="/eventsimage/{{$data->image}}">
              ...
              <div class="form-group">
                ...
                <input type="file" id="inputClientCompany" class="form-control" name="image" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" class="form-control" name="description" value="{{$data->description}}" required>
                  </div>
